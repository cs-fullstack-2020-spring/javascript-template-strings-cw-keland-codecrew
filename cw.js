...
let constestant = (`1_M_1337!`); // there is no need to put values in parens when you are declaring a variable 
let score = (`9001.`);
...
// you have nested if statments
    ...
    // } use CTRL + SHIFT + I to refomat your code
// } and click on an opening brace/tag/paren/whatever to see when the tag ends
